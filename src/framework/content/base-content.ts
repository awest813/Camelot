...
export const frameworkBaseContent: RpgContentBundle = {
  ...
  quests: [
    ...
    },
    {
      ...
      xpReward: 150,
      rewardGold: 150,
      rewardItems: [{ itemId: "health_potion", quantity: 2 }],
  ...
  npcArchetypes: [
    ...
    },
    {
      ...
      // Cowardly at heart — flee when badly wounded
      aiProfile: { fleesBelowHealthPct: 0.25 },
    },
    {
      id: "archetype_bandit_archer",
      name: "Bandit Archer",
      description: "A bandit lookout who rains arrows from the camp's edge.",
      role: "enemy",
      factionId: "bandits",
      isHostile: true,
      isMerchant: false,
      ...
      baseHealth: 65,
      level: 2,
      skills: { "marksman": 35, "light_armor": 20 },
      disposition: 10,
      respawns: true,
      // Holds at range and shoots instead of charging into melee.
      aiProfile: {
        aggroRange: 14,
        attackRange: 16,
        attackDamage: 7,
        attackCooldown: 2.4,
        attackArchetype: "ranged",
        fleesBelowHealthPct: 0.35,
      },
    },
    {
    ...
    },
    {
      ...
      // Fights at range with fire bolts instead of closing to melee.
      aiProfile: {
        aggroRange: 15,
        attackRange: 14,
        attackDamage: 9,
